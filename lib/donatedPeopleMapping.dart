        ...
        if(snapshots.connectionState==ConnectionState.active)
          {
            return  ListView.builder(
              ...
              return GestureDetector(
                ...
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>AssignVolunteerToQueryAndRequirement(queryId: widget.queryId, requirementId: snapshots.data?.docs[index].id.toString(), lat: double.parse(snapshots.data?.docs[index]['latitude']), long: double.parse(snapshots.data?.docs[index]['longitude']))));
                },

  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        BottomNavigationBarItem(icon: Icon(Icons.hail),label: "VOLUNTEER REQUEST")
...
class _HomeState extends State<Home> {
  @override
  Widget build(BuildContext context) {
    return StreamBuilder(stream: FirebaseFirestore.instance.collection("query").snapshots(), builder: (context,snapshot){
      ...
      return ListView.builder(itemBuilder: (context,index){
        ...
        return InkWell(
          onTap: (){
            ...
            Navigator.push(context, MaterialPageRoute(builder: (ctx)=>DonatedPeopleList(options:snapshot.data?.docs[index]['options'].toString(),queryId: snapshot.data?.docs[index].id.toString(),)));
          },
          child: Card(
            child: Container(

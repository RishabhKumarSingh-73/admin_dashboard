...
class AssignVolunteerToQueryAndRequirement extends StatefulWidget {
  ...
  const AssignVolunteerToQueryAndRequirement(
      {super.key,
  ...
  @override
  State<AssignVolunteerToQueryAndRequirement> createState() =>
      _AssignVolunteerToQueryAndRequirementState();
}

class _AssignVolunteerToQueryAndRequirementState
    extends State<AssignVolunteerToQueryAndRequirement> {
      ...
      body: StreamBuilder(
          ...
          builder: (context, snapshots) {
            if (snapshots.hasData) {
              //volunteer list
              List<Map<String, dynamic>> volunteer =
              ...
              volunteer.forEach((vol) {
                vol['distance'] = calculateDistance(
                    widget.lat, widget.long, vol['lat'], vol['long']);
              });
              ...
              return ListView.builder(
                  ...
                  itemBuilder: (context, Index) {
                    return GestureDetector(
                      onTap: () async {
                        DocumentSnapshot<Map<String, dynamic>> queryDocsnap =
                            await FirebaseFirestore.instance
                                .collection('query')
                                .doc(widget.queryId)
                                .get();
                        DocumentSnapshot<Map<String, dynamic>> reqDocsnap =
                            await FirebaseFirestore.instance
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text(
                            'distance: ${volunteer[Index]['distance'].toString()} km'),
                      ),
                    );
                  });
            } else {
